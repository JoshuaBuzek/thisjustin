    ...
    SEMICOLON.initialize = {
        ...
        jsLinking: function(i, n) {
            ...
            let t, s = Function("return " + n.pluginfn)(),
                a = "js/",
                l = !1;
            "undefined" != typeof scwJsPath && (a = scwJsPath + "/"), "undefined" != typeof scwDisableJsAJAX && !0 === scwDisableJsAJAX && (l = !0), t = /^(f|ht)tps?:\/\//i.test(window.decodeURIComponent(n.file)) ? n.file : a + n.file, s ? SEMICOLON.initialize.execPlugin(i, n) : l ? console.log(n.error) : e.ajax({
                url: t,
                dataType: "script",
                cache: !0,
                crossDomain: !0,
        ...
        sliderParallax: function() {
            ...
            let e, i, n = SEMICOLON.slider.sliderParallaxOffset(),
                a = Q.outerHeight();
            t = window.pageXOffset, s = window.pageYOffset, !o.hasClass("device-xl") && !o.hasClass("device-lg") || SEMICOLON.isMobile.any() ? Q.find(".slider-inner").length > 0 ? (SEMICOLON.slider.sliderParallaxSet(0, 0, ie), SEMICOLON.slider.sliderParallaxSet(0, 0, ee)) : (SEMICOLON.slider.sliderParallaxSet(0, 0, Z), SEMICOLON.slider.sliderParallaxSet(0, 0, ee)) : (a + n + 50 > s ? (Q.addClass("slider-parallax-visible").removeClass("slider-parallax-invisible"), s > n ? Q.find(".slider-inner").length > 0 ? (e = -.4 * (s - n), i = -.15 * (s - n), SEMICOLON.slider.sliderParallaxSet(0, e, ie), SEMICOLON.slider.sliderParallaxSet(0, i, ee)) : (e = (s - n) / 1.5, i = (s - n) / 7, SEMICOLON.slider.sliderParallaxSet(0, e, Z), SEMICOLON.slider.sliderParallaxSet(0, i, ee)) : Q.find(".slider-inner").length > 0 ? (SEMICOLON.slider.sliderParallaxSet(0, 0, ie), SEMICOLON.slider.sliderParallaxSet(0, 0, ee)) : (SEMICOLON.slider.sliderParallaxSet(0, 0, Z), SEMICOLON.slider.sliderParallaxSet(0, 0, ee))) : Q.addClass("slider-parallax-invisible").removeClass("slider-parallax-visible"), requestAnimationFrame(function() {
                SEMICOLON.slider.sliderParallax(), SEMICOLON.slider.sliderElementsFade()
            }))
        },
        ...
        init: function() {
            SEMICOLON.header.menufunctions(), SEMICOLON.header.fullWidthMenu(), SEMICOLON.header.stickyMenu(), SEMICOLON.initialize.dataResponsiveHeights(), SEMICOLON.initialize.stickFooterOnSmall(), SEMICOLON.slider.sliderDimensions(), SEMICOLON.widget.html5Video(), SEMICOLON.widget.masonryThumbs(), SEMICOLON.initialize.dataResponsiveClasses(), SEMICOLON.customization.onResize(), E = l.width(), e(window).trigger("scwWindowResize")
        }
        ...
        init: function() {
            SEMICOLON.slider.swiperSliderMenu(!0), SEMICOLON.slider.revolutionSliderMenu(!0), SEMICOLON.initialize.stickFooterOnSmall(), SEMICOLON.widget.gridInit(), l.on("pluginIsotopeReady", function() {
